...
class SashimiSTEP1 extends StatefulWidget {
  @override
  _HomeState createState() => _HomeState();
}

class _HomeState extends State<SashimiSTEP1> {
  ...
  loadVideoPlayer() {
    controller =
        VideoPlayerController.asset('assets/videos/Recommendations/S28-1.mp4');
