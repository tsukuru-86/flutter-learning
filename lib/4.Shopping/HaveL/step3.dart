...
class HaveLSTEP3 extends StatefulWidget{

  @override
  _HomeState createState() => _HomeState();
}

class _HomeState extends State<HaveLSTEP3> {
  ...
  loadVideoPlayer(){
    controller = VideoPlayerController.asset('assets/videos/Shopping/S12-3.mp4');
