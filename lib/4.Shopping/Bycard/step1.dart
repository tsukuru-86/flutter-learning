...
class BySTEP1 extends StatefulWidget {
  @override
  _HomeState createState() => _HomeState();
}

class _HomeState extends State<BySTEP1> {
  ...
  loadVideoPlayer() {
    controller =
        VideoPlayerController.asset('assets/videos/Shopping/S15-1.mp4');
