...
class ItSTEP1 extends StatefulWidget {
  @override
  _HomeState createState() => _HomeState();
}

class _HomeState extends State<ItSTEP1> {
  ...
  loadVideoPlayer() {
    controller =
        VideoPlayerController.asset('assets/videos/Shopping/S14-1.mp4');
