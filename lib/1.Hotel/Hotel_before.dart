...
class HotelPageBefore extends StatelessWidget {
  get child => null;
                        ...
                        Container(
                          ...
                          child: InkWell(
                            onTap: (){
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => CiHSTEP1()),
                              );
                            },
                            child: Container(
                              height: 90,
                        ...
                        Container(
                          ...
                          child: InkWell(
                            onTap: (){
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => CiHSTEP2a()),
                              );
                            },
                            child: Container(
                              height: 90,
                        ...
                        Container(
                          ...
                          child: InkWell(
                            onTap: (){
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => CiHSTEP3()),
                              );
                            },
                            child: Container(
                              height: 90,
                        ...
                        Container(
                          ...
                          child: InkWell(
                            onTap: (){
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => PaTSTEP1()),
                              );
                            },
                            child: Container(
                              height: 90,
                        ...
                        Container(
                          ...
                          child: InkWell(
                            onTap: (){
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => PaTSTEP2a()),
                              );
                            },
                            child: Container(
                              height: 90,
                        ...
                        Container(
                          ...
                          child: InkWell(
                            onTap: (){
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => PaTSTEP3()),
                              );
                            },
                            child: Container(
                              height: 90,
                        ...
                        Container(
                          ...
                          child: InkWell(
                            onTap: (){
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => CwyhSTEP1()),
                              );
                            },
                            child: Container(
                              height: 90,
                        ...
                        Container(
                          ...
                          child: InkWell(
                            onTap: (){
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => CwyhSTEP2a()),
                              );
                            },
                            child: Container(
                              height: 90,
                        ...
                        Container(
                          ...
                          child: InkWell(
                            onTap: (){
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => CwyhSTEP3()),
                              );
                            },
                            child: Container(
                              height: 90,
                        ...
                        Container(
                          ...
                          child: InkWell(
                            onTap: (){
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => eggSTEP1()),
                              );
                            },
                            child: Container(
                              height: 90,
                        ...
                        Container(
                          ...
                          child: InkWell(
                            onTap: (){
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => eggSTEP2a()),
                              );
                            },
                            child: Container(
                              height: 90,
                        ...
                        Container(
                          ...
                          child: InkWell(
                            onTap: (){
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => eggSTEP3()),
                              );
                            },
                            child: Container(
                              height: 90,
