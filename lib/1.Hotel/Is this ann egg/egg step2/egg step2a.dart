...
class eggSTEP2a extends StatefulWidget {
  @override
  _HomeState createState() => _HomeState();
}

class _HomeState extends State<eggSTEP2a> {
  ...
  loadVideoPlayer() {
    controller = VideoPlayerController.asset('assets/videos/Hotel/S4-2a.mp4');
