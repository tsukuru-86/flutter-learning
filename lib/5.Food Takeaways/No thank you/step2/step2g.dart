...
class NTYSTEP2g extends StatefulWidget {
  @override
  _HomeState createState() => _HomeState();
}

class _HomeState extends State<NTYSTEP2g> {
  ...
  loadVideoPlayer() {
    controller =
        VideoPlayerController.asset('assets/videos/Takeaway/S19-2-7.mp4');
