...
class isare extends StatefulWidget {
  const isare({Key? key}) : super(key: key);

  @override
  State<isare> createState() => isarePageState();
}

class isarePageState extends State<isare> {
  final String imagePath = 'assets/images/4 This is:are.png';
