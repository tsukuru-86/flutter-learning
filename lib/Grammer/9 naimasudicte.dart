...
class naimasudicte extends StatefulWidget {
  const naimasudicte({Key? key}) : super(key: key);

  @override
  State<naimasudicte> createState() => naimasudictePageState();
}

class naimasudictePageState extends State<naimasudicte> {
  final String imagePath = 'assets/images/9 nai:masu:dic:te.png';
