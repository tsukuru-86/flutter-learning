...
class IESTEP2e extends StatefulWidget {
  @override
  _HomeState createState() => _HomeState();
}

class _HomeState extends State<IESTEP2e> {
  ...
  loadVideoPlayer() {
    controller =
        VideoPlayerController.asset('assets/videos/Restaurant/S7-2-5.mp4');
