...
class LOSTEP1 extends StatefulWidget {
  @override
  _HomeState createState() => _HomeState();
}

class _HomeState extends State<LOSTEP1> {
  ...
  loadVideoPlayer() {
    controller =
        VideoPlayerController.asset('assets/videos/Restaurant/S8-1.mp4');
