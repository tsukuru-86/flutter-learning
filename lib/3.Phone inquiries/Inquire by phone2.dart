          ...
          child: Column(
            children: [
              ...
              _buildStepCard(
                  ...
                  [
                    _buildStepButton(
                        'STEP1', context, Color(0xFF00afcc), FSTEP1()),
                    _buildStepButton(
                        'STEP2', context, Color(0xFF4593A0), FSTEP2a()),
                    _buildStepButton(
                        'STEP3', context, Color(0xFF476b6b), FSTEP3()),
                  ],
                  context),
              _buildStepCard(
                  ...
                  [
                    _buildStepButton(
                        'STEP1', context, Color(0xFF00afcc), HOWSTEP1()),
                    _buildStepButton(
                        'STEP2', context, Color(0xFF4593A0), HOWSTEP2a()),
                    _buildStepButton(
                        'STEP3', context, Color(0xFF476b6b), HOWSTEP3()),
                  ],
                  context),
              _buildStepCard(
                  ...
                  [
                    _buildStepButton(
                        'STEP1', context, Color(0xFF00afcc), WHSTEP1()),
                    _buildStepButton(
                        'STEP2', context, Color(0xFF4593A0), WHSTEP2a()),
                    _buildStepButton(
                        'STEP3', context, Color(0xFF476b6b), WHSTEP3()),
                  ],
                  context),
            ],
          ),
