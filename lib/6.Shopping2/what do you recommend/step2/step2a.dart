...
class recommendSTEP2a extends StatefulWidget{
  @override
  _HomeState createState() => _HomeState();
}

class _HomeState extends State<recommendSTEP2a> {
  ...
  loadVideoPlayer(){
    controller = VideoPlayerController.asset('assets/videos/Shopping2/S21-2-1.mp4');
              ...
              child: IconButton(
                ...
                onPressed: ()async {
                  await Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(builder: (context) => recommendSTEP2b(),
                    ),
                  );
                },
                iconSize: 50,
