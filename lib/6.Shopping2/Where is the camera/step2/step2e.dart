...
class cameraSTEP2e extends StatefulWidget {
  @override
  _HomeState createState() => _HomeState();
}

class _HomeState extends State<cameraSTEP2e> {
  ...
  loadVideoPlayer() {
    controller =
        VideoPlayerController.asset('assets/videos/Shopping2/S20-2-5.mp4');
