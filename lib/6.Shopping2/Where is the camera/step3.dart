...
class cameraSTEP3 extends StatefulWidget{
  @override
  _HomeState createState() => _HomeState();
}

class _HomeState extends State<cameraSTEP3> {
  ...
  loadVideoPlayer(){
    controller = VideoPlayerController.asset('assets/videos/Shopping2/S20-3.mp4');
