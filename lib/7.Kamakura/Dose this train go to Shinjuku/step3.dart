...
class ShinjukuSTEP3 extends StatefulWidget{
  @override
  _HomeState createState() => _HomeState();
}

class _HomeState extends State<ShinjukuSTEP3> {
  ...
  loadVideoPlayer(){
    controller = VideoPlayerController.asset('assets/videos/Kamakura/S23-3.mp4');
