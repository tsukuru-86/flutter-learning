...
class trainSTEP2a extends StatefulWidget{

  @override
  _HomeState createState() => _HomeState();
}

class _HomeState extends State<trainSTEP2a> {
  ...
  loadVideoPlayer(){
    controller = VideoPlayerController.asset('assets/videos/Kamakura/S25-2-1.mp4');
              ...
              child: IconButton(
                ...
                onPressed: ()async {
                  await Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(builder: (context) => trainSTEP2b(),
                    ),
                  );
                },
                iconSize: 50,
